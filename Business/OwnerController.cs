...
namespace UResidence
{
    public class OwnerController
    {
        ...
        {
            const string GET_ALL = @"SELECT Id,BldgNo,UnitNo,Fname,Mname,Lname,Bdate,CelNo,Email,Deleted,URL FROM [tbOwner] where Deleted=0 order by Id";
        ...
        {
            const string GET_RECORD = @"SELECT Id,BldgNo,UnitNo,Fname,Mname,Lname,Bdate,CelNo,Email,Deleted,URL FROM [tbOwner] WHERE Email = @Email";
