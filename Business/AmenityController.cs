...
namespace UResidence
{
    public class AmenityController
    {
        ...
        {
            const string GET_ALL = @" select a.Id,a.Description,a.Capacity,a.AmenityName,a.URL,a.Rate,a.Color,a.Location,ISNULL(sp.AdultRate,0) as AdultRate,ISNULL(sp.ChildRate,0) as ChildRate from tbAmenity a full join tbSwimmingPool sp on a.Id=sp.AmenityId where Color!='Black' order by a.Id ";
        ...
        {
            const string GET_ALL = @"select a.Id,Description,Capacity,AmenityName,ia.URL,Rate,Color,Location from tbAmenity a inner join tbImageAmenity ia on a.Id=ia.AmenityId where a.AmenityId=@Id";
        ...
        {
            const string GET_RECORD = @" select a.Id,a.Description,a.Capacity,a.AmenityName,a.URL,a.Rate,a.Color,a.Location,ISNULL(sp.AdultRate,0) as AdultRate,ISNULL(sp.ChildRate,0) as ChildRate from tbAmenity a full join tbSwimmingPool sp on a.Id=sp.AmenityId WHERE a.AmenityName = @AmenityName order by a.AmenityName ";
        ...
        {
            const string GET_RECORD = @" select a.Id,a.Description,a.Capacity,a.AmenityName,a.URL,a.Rate,a.Color,a.Location,ISNULL(sp.AdultRate,0) as AdultRate,ISNULL(sp.ChildRate,0) as ChildRate from tbAmenity a full join tbSwimmingPool sp on a.Id=sp.AmenityId where a.Id=@Id and Color!='Black' order by Id ";
        ...
        {
            const string GET_RECORD = @" select a.Id,a.Description,a.Capacity,a.AmenityName,a.URL,a.Rate,a.Color,a.Location,ISNULL(sp.AdultRate,0) as AdultRate,ISNULL(sp.ChildRate,0) as ChildRate from tbAmenity a full join tbSwimmingPool sp on a.Id=sp.AmenityId WHERE a.Id = @Id";
            Amenity ret = default(Amenity);
            SqlCommand com = new SqlCommand(GET_RECORD);
            com.Parameters.Add(new SqlParameter("@Id", id));
            ret = SqlManager.Select<Amenity>(com).First();
