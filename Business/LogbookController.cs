...
namespace UResidence
{
    public class LogbookController
    {
        ...
        {
            const string GET_ALL = @"select Id,Convert(varchar(15),Date,101) as Date,VisitorName,ResidentName,Convert(varchar(15),TimeIn,108),Convert(varchar(15),TimeOut,108),Purpose,ISNULL(URL,'none') from [tbLogbook] where Convert(varchar(15),Date,101)=Convert(varchar(15),GETDATE(),101)";
        ...
        {
            const string GET_ALL = @"select Id,Convert(varchar(15),Date,101) as Date,VisitorName,ResidentName,Convert(varchar(15),TimeIn,108),Convert(varchar(15),TimeOut,108),Purpose,ISNULL(URL,'none') from [tbLogbook] where Convert(varchar(15),Date,101)=Convert(varchar(15),@date,101)";
            List<Logbook> ret = default(List<Logbook>);
            SqlCommand com = new SqlCommand(GET_ALL);
