...
namespace UResidence
{
    public class ReceiptController
    {
        ...
        {
            const string GET_ALL = @"SELECT Id,RefNo,Totalpayment,Date,Description,CreatedBy FROM [tbReceipt] order by Id";
        ...
        {
            const string GET_ALL = @"SELECT Id,RefNo,Totalpayment,Date,Description,CreatedBy FROM [tbReceipt] where RefNo=@RefNo";
        ...
        {
            const string GET_RECORD = @"SELECT Id,RefNo,Totalpayment,Date,Description,CreatedBy FROM [tbReceipt] WHERE Id = @ORNo";
        ...
        {
            const string GET_RECORD = @"SELECT Id,RefNo,Totalpayment,Date,Description,CreatedBy FROM [tbReceipt] WHERE RefNo = @RefNo";
        ...
        {
            const string GET_UPDATE = @"update [tbReceipt] set  Totalpayment = @Totalpayment , Date= @Date , Description=@Description WHERE Id= @ORNo";
        ...
        public static bool Insert(Receipt usr)
        {
            ...
            const string GET_INSERT = @"insert [tbReceipt] (RefNo,Totalpayment,Date,Description,CreatedBy) values (@RefNo, @Totalpayment, @Date, @Description,@CreatedBy)";
