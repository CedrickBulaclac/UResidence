...
namespace UResidence
{
    public class AdminController
    {
        ...
        {
            const string GET_ALL = @"SELECT a.Id,Fname,Mname,Lname,Bdate,CelNo,Email,Deleted,Url,case Level when 0 then 'Super Admin'  when 1 then 'Manager' when 2 then 'Finance' when 3 then 'Cashier' when 4 then 'Reservation Admin' when 5 then 'Registration' when 6 then 'Security Guard' when 7 then 'Security Guard' end as Role, Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,ReservationModule,RegistrationModule,PaymentModule,ReversalModule,LogBookModule,LoginId FROM [tbAdmin] a inner join tbLogin l on l.Id=a.LoginId where Deleted=0 and Level!=0 order by Role asc";
        ...
        {
            const string GET_ALL = @"SELECT a.Id,Fname,Mname,Lname,Bdate,CelNo,Email,Deleted,Url,case Level when 0 then 'Super Admin'  when 1 then 'Manager' when 2 then 'Finance' when 3 then 'Cashier' when 4 then 'Reservation Admin' when 5 then 'Registration' when 6 then 'Security Guard' when 7 then 'Security Guard' end as Role,Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,ReservationModule,RegistrationModule,PaymentModule,ReversalModule,LogBookModule,LoginId FROM [tbAdmin] a inner join tbLogin l on l.Id=a.LoginId where Deleted=0 and Level=3 order by Role asc";
            List<Admin> ret = default(List<Admin>);
            SqlCommand com = new SqlCommand(GET_ALL);
            ret = SqlManager.Select<Admin>(com);
            return ret;
        ...
        {
            const string GET_ALL = @"SELECT a.Id,Fname,Mname,Lname,Bdate,CelNo,Email,Deleted,Url,case Level when 0 then 'Super Admin'  when 1 then 'Manager' when 2 then 'Finance' when 3 then 'Cashier' when 4 then 'Reservation Admin' when 5 then 'Registration' when 6 then 'Security Guard' when 7 then 'Security Guard' end as Role, Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,ReservationModule,RegistrationModule,PaymentModule,ReversalModule,LogBookModule,LoginId FROM [tbAdmin] a inner join tbLogin l on l.Id=a.LoginId where Deleted=0 and Level=7 order by Role asc";
            List<Admin> ret = default(List<Admin>);
            SqlCommand com = new SqlCommand(GET_ALL);
            ret = SqlManager.Select<Admin>(com);
            return ret;
        ...
        {
            const string GET_ALL = @"SELECT a.Id,Fname,Mname,Lname,Bdate,CelNo,Email,Deleted,Url,case Level when 0 then 'Super Admin'  when 1 then 'Manager' when 2 then 'Finance' when 3 then 'Cashier' when 4 then 'Reservation Admin' when 5 then 'Registration' when 6 then 'Security Guard' when 7 then 'Security Guard' end as Role, Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,ReservationModule,RegistrationModule,PaymentModule,ReversalModule,LogBookModule,LoginId FROM [tbAdmin] a inner join tbLogin l on l.Id=a.LoginId where Deleted=0 and a.Id=@Rid and Level!=0 order by Role asc";
            List<Admin> ret = default(List<Admin>);
            SqlCommand com = new SqlCommand(GET_ALL);
        ...
        {
           const string GET_RECORD = @"SELECT a.Id,Fname,Mname,Lname,Bdate,CelNo,Email,Deleted,Url,case Level when 0 then 'Super Admin'  when 1 then 'Manager' when 2 then 'Finance' when 3 then 'Cashier' when 4 then 'Reservation Admin' when 5 then 'Registration' when 6 then 'Security Guard' when 7 then 'Security Guard' end as Role, Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,ReservationModule,RegistrationModule,PaymentModule,ReversalModule,LogBookModule,LoginId FROM [tbAdmin] a inner join tbLogin l on l.Id=a.LoginId where a.LoginId = @Id and a.Deleted=0 order by Role asc";
        ...
        {
            const string GET_RECORD = @"SELECT a.Id,Fname,Mname,Lname,Bdate,CelNo,Email,Deleted,Url,case Level when 0 then 'Super Admin'  when 1 then 'Manager' when 2 then 'Finance' when 3 then 'Cashier' when 4 then 'Reservation Admin' when 5 then 'Registration' when 6 then 'Security Guard' when 7 then 'Security Guard' end as Role, Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,ReservationModule,RegistrationModule,PaymentModule,ReversalModule,LogBookModule,LoginId FROM [tbAdmin] a inner join tbLogin l on l.Id=a.LoginId where a.Id =@Id and Deleted=0  order by Role asc";
            Admin ret = default(Admin);
            SqlCommand com = new SqlCommand(GET_RECORD);
        ...
        {
            const string GET_RECORD = @"SELECT a.Id,Fname,Mname,Lname,Bdate,CelNo,Email,Deleted,Url,case Level when 0 then 'Super Admin'  when 1 then 'Manager' when 2 then 'Finance' when 3 then 'Cashier' when 4 then 'Reservation Admin' when 5 then 'Registration' when 6 then 'Security Guard' when 7 then 'Security Guard' end as Role , Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,ReservationModule,RegistrationModule,PaymentModule,ReversalModule,LogBookModule,LoginId FROM [tbAdmin] a inner join tbLogin l on l.Id=a.LoginId where a.Id=@Id and Level!=0 order by Role asc";
            Admin ret = default(Admin);
            SqlCommand com = new SqlCommand(GET_RECORD);
            com.Parameters.Add(new SqlParameter("@Id", Id));
            ret = SqlManager.Select<Admin>(com).First();
        ...
        {
            const string GET_RECORD = @"SELECT a.Id,Fname,Mname,Lname,Bdate,CelNo,Email,Deleted,Url,case ISNULL(Level,0) when 0 then 'Super Admin'  when 1 then 'Manager' when 2 then 'Finance' when 3 then 'Cashier' when 4 then 'Reservation Admin' when 5 then 'Registration' when 6 then 'Security Guard' when 7 then 'Security Guard' end as Role, Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,ReservationModule,RegistrationModule,PaymentModule,ReversalModule,LogBookModule,LoginId FROM [tbAdmin] a full join tbLogin l on l.Id=a.LoginId WHERE Email = @Email and Deleted=0";
            Admin ret = default(Admin);
            SqlCommand com = new SqlCommand(GET_RECORD);
