...
namespace UResidence
{
    public class TenantController
    {
        ...
        {
            const string GET_ALL = @"SELECT Id,UnitNo,BldgNo,Fname,Mname,Lname,Bdate,CelNo,Email,LeaseStart,LeaseEnd,Deleted,URL,MovingIn,MovingOut,Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,Convert(varchar(25),LeaseStart,100)+' - '+Convert(varchar(25),LeaseEnd,100) as Lease,LoginId,ENo,EName,EAddress,Address FROM [tbTenant] where Deleted=0  order by Id";
        ...
        {
            const string GET_ALL = @"select t.Id,t.UnitNo,t.BldgNo,t.Fname,t.Mname,t.Lname,t.Bdate,t.CelNo,t.Email,t.LeaseStart,t.LeaseEnd,t.Deleted,t.URL,t.MovingIn,t.MovingOut,t.Fname+' '+t.Mname+' '+t.Lname as Fullname,FORMAT(t.Bdate,'MMM dd yyyy') as Birthday,Convert(varchar(25),t.LeaseStart,100)+' - '+Convert(varchar(25),t.LeaseEnd,100) as Lease,t.LoginId,t.ENo,t.EName,t.EAddress,t.Address from tbOwner o inner join tbResidence r on o.Id=r.OwnerNo inner join tbTenant t on t.Id=r.TenantNo where t.Deleted=0 and o.Id=@Id";
        ...
        {
            const string GET_RECORD = @"SELECT Id,UnitNo,BldgNo,Fname,Mname,Lname,Bdate,CelNo,Email,LeaseStart,LeaseEnd,Deleted,URL,MovingIn,MovingOut,Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,Convert(varchar(25),LeaseStart,100)+' - '+Convert(varchar(25),LeaseEnd,100) as Lease,LoginId,ENo,EName,EAddress,Address  FROM [tbTenant] WHERE Email = @Email and Deleted=0 ";
        ...
        {
            const string GET_RECORD = @"SELECT Id,UnitNo,BldgNo,Fname,Mname,Lname,Bdate,CelNo,Email,LeaseStart,LeaseEnd,Deleted,URL,MovingIn,MovingOut,Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,Convert(varchar(25),LeaseStart,100)+' - '+Convert(varchar(25),LeaseEnd,100) as Lease,LoginId,ENo,EName,EAddress,Address  FROM [tbTenant] where BldgNo=@BldgNo and UnitNo=@UnitNo and Deleted=0";
        ...
        {
            const string GET_RECORD = @" SELECT Id,UnitNo,BldgNo,Fname,Mname,Lname,Bdate,CelNo,Email,LeaseStart,LeaseEnd,Deleted,URL,MovingIn,MovingOut,Fname+' '+Mname+' '+Lname as Fullname,FORMAT(Bdate,'MMM dd yyyy') as Birthday,Convert(varchar(25),LeaseStart,100)+' - '+Convert(varchar(25),LeaseEnd,100) as Lease,LoginId,ENo,EName,EAddress,Address FROM [tbTenant] where Deleted=0 and LeaseEnd Between @start and @end ";
        ...
        {
            const string GET_UPDATE = @"update [tbTenant] set Fname = @Fname, Mname = @Mname, Lname = @Lname, Bdate = @Bdate, CelNo = @CelNo, Email = @Email,BldgNo=@BldgNo,UnitNo=@UnitNo,ENo=@ENo,EName=@EName,EAddress=@EAddress,Address=@Address,LeaseStart=@LeaseStart,LeaseEnd=@LeaseEnd WHERE Id = @Id";
            ...
            com.Parameters.Add(new SqlParameter("@Address", usr.Address));
        ...
        public static bool Insert(Tenant usr)
        {
            ...
            const string GET_INSERT = @"insert [tbTenant] (UnitNo,BldgNo,Fname,Mname,Lname,Bdate,CelNo,Email,LeaseStart,LeaseEnd,Deleted,URL,MovingIn,MovingOut,LoginId,ENo,EName,EAddress,Address) values (@UnitNo,@BldgNo,@Fname,@Mname,@Lname,@Bdate,@CelNo,@Email, @LeaseStart, @LeaseEnd,@Deleted,@URL,@MovingIn,@MovingOut,0,@ENo,@EName,@EAddress,@Address)";
